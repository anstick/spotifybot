...
function endDialog(session, message) {
...
module.exports = [
            ...
            if (sounds && sounds.length){
                ...
                SpeechRecognizer.recognize(sounds[0].contentUrl)
                   .then(function (text) {
                    ...
                    .catch(function (err) {
                       endDialog(session,'Wat? I can\'t hear you. Could you please repeat?');
                    });
            }
            else{
                next();
    ...
    function (session, _, next) {
        ...
        SearchSongController
            ...
            .catch(function (err) {
                endDialog(session, 'Sorry, I\'m too tired for today. Could you please come back tomorrow?');
            });
    },
